                      ...
                      child: Row(
                        ...
                        onTap: () {
                          setState(() {
                                   userCartList.add({
                                'id': favLastId++,
                                'pic': widget.laptopDetails["pic"],
                                'name': widget.laptopDetails["name"],
                                'price': widget.laptopDetails["price"],
                                'size': widget.laptopDetails["size"],
                                'camera': widget.laptopDetails["camera"],
                                'ram': widget.laptopDetails["ram"],
                                'battery': widget.laptopDetails["battery"],
                                'rating': widget.laptopDetails["rating"],
                                'status': widget.laptopDetails["status"],
                                'count': widget.laptopDetails["count"],
                              });
                            Navigator.push(
                                context,
                                MaterialPageRoute(

...
class Laptopdetailscart extends StatefulWidget {
  final laptopDetails;
  Laptopdetailscart(this.laptopDetails);
  @override
  _LaptopdetailscartState createState() => _LaptopdetailscartState();
}

class _LaptopdetailscartState extends State<Laptopdetailscart> {
  @override
